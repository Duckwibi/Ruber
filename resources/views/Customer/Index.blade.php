            ...
            <div id="content" class="site-content" role="main">
                <section class="section">
                    ...
                    <div class="block block-sliders">
                        <div class="slick-sliders" data-autoplay="true" data-dots="true" data-nav="false"
                                ...
                                <div class="item slick-slide">
                                    <div class="item-content">
                                        <div class="content-image">
                                            <img width="1920" height="1080" src="{{ $sliderBanner->image }}" alt="{{ $sliderBanner->image }}">
                                        </div>
                                        <div class="section-padding">
                                            <div class="section-container">
                                                <div class="item-info horizontal-start vertical-middle">
                                                    <div class="content">
                                                        <div class="subtitle-slider">{{ $sliderBanner->subTitle }}</div>
                                                        <h2 class="title-slider">{{ $sliderBanner->title }}</h2>
                                                        <div class="description-slider">{{ $sliderBanner->description }}</div>
                                                        <a class="button-slider button-white" href="{{ $sliderBanner->url }}">SHOP NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="banner-wrapper banners">
                                                        <div class="banner-image">
                                                            <a href="shop-grid-left.html">
                                                                <img width="571" height="622"
                                                                    src="/Customer/media/banner/product-cat-1.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                            ...
                                                            <div class="info">
                                                                <div class="content">
                                                                    <a class="button button-white"
                                                                        href="shop-grid-left.html">Furniture</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="block-widget-banner layout-1">
                                                                    <div class="bg-banner">
                                                                        <div class="banner-wrapper banners">
                                                                            <div class="banner-image">
                                                                                <a href="shop-grid-left.html">
                                                                                    <img width="406" height="304"
                                                                                        src="/Customer/media/banner/product-cat-2.jpg"
                                                                                        alt="Banner Image">
                                                                                </a>
                                                                            </div>
                                                                            <div class="banner-wrapper-infor">
                                                                                <div class="info">
                                                                                    <div class="content">
                                                                                        <a class="button button-white"
                                                                                            href="shop-grid-left.html">Lighting</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="bg-banner">
                                                                        <div class="banner-wrapper banners">
                                                                            <div class="banner-image">
                                                                                <a href="shop-grid-left.html">
                                                                                    <img width="406" height="304"
                                                                                        src="/Customer/media/banner/product-cat-3.jpg"
                                                                                        alt="Banner Image">
                                                                                </a>
                                                                            </div>
                                                                            <div class="banner-wrapper-infor">
                                                                                <div class="info">
                                                                                    <div class="content">
                                                                                        <a class="button button-white"
                                                                                            href="shop-grid-left.html">Modern</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="bg-banner">
                                                                        <div class="banner-wrapper banners">
                                                                            <div class="banner-image">
                                                                                <a href="shop-grid-left.html">
                                                                                    <img width="406" height="304"
                                                                                        src="/Customer/media/banner/product-cat-4.jpg"
                                                                                        alt="Banner Image">
                                                                                </a>
                                                                            </div>
                                                                            <div class="banner-wrapper-infor">
                                                                                <div class="info">
                                                                                    <div class="content">
                                                                                        <a class="button button-white"
                                                                                            href="shop-grid-left.html">Accessories</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="/Customer/Product/ProductDetailPage?id={{ $product->id }}">
                                                                        ...
                                                                        <img width="600" height="600" src="{{ $product->imageHover }}"
                                                                            class="hover-image back" alt="{{ $product->imageHover }}">
                                                                    </a>
                                                                </div>
                                        ...
                                        <div class="block-widget-wrap">
                                            <div class="block-widget-video">
                                                <div class="video-thumb">
                                                    <img width="565" height="635" class="img-responsive"
                                                        src="/Customer/media/banner/video-1.jpg" alt="Image Video">
                                                </div>
                                                <div class="video-wrap">
                                                    <div class="video"
                                                        data-src="https://www.youtube.com/embed/VQOJaYUPZR8"
                                                        data-toggle="modal" data-target="#video-popup">
                                                        <i class="fa fa-play" aria-hidden="true"></i>
                                                    </div>
                                                    <div class="content-video modal fade" id="video-popup" tabindex="-1"
                                        ...
                                        <div class="block-widget-wrap">
                                            <div class="block-widget-video">
                                                <div class="video-text">
                                                    ...
                                                    <div class="description">In our design and production processes, we
                                                        are always looking at where environmental thinking and economic
                                                        ...
                                                        <g>
                                                            <g xmlns="http://www.w3.org/2000/svg" id="Shipping">
                                                                ...
                                                                <path
                                                                    ...
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M25,28H19a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M25,25H19a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M29,25H28a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M25,22H19a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M29,22H28a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path d="M29,28H28a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Z"
                                                                    fill="" data-original="" style=""></path>
                                                                <path

            ...
            <div id="title" class="page-title">
                <div class="section-container">
                    ...
                    <div class="breadcrumbs">
                        <a href="index-2.html">Home</a><span class="delimiter"></span>Reset Password
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="form-register">
                                                <form onsubmit="return false;" class="register">
                                                    <div class="email">
                                                        ...
                                                        <input type="text" class="input-text resetPasswordNewPassword">
                                                    </div>
...
<script>
    window.addEventListener("load", () => {
        document.querySelector(".resetPasswordSubmit").addEventListener("click", () => {
            $.ajax({
                url: "/Customer/Authenticate/ResetPassword",
                type: "post",
                data: {
                    newPassword: document.querySelector(".resetPasswordNewPassword").value,

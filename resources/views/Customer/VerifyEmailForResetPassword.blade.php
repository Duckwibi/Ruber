                                            ...
                                            <div class="form-register">
                                                <form onsubmit="return false;" class="register">
                                                    <div class="email">
                                                        ...
                                                        <input type="text" class="input-text resetPasswordOtp">
                                                    </div>
...
<script>
    window.addEventListener("load", () => {
        document.querySelector(".resetPasswordSubmit").addEventListener("click", () => {
            $.ajax({
                url: "/Customer/Authenticate/VerifyEmailForResetPassword",
                type: "post",
                data: {
                    otp: document.querySelector(".resetPasswordOtp").value,
                    _token: "{{ csrf_token() }}"
                },
                dataType: "json",
                beforeSend: () => {
